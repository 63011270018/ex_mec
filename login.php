...
<body style="background-color:aliceblue;">
    <div class="container">
        <div class="mx-auto col-md-4">
            ...
            <h4 class="text-center pt-3">เข้าสู่ระบบ<br>ระบบการบริหาร<br>จัดการข้อมูลผู้ใช้งานระบบ<br>เครือข่ายอินเตอร์เน็ต</h4>
            ...
            <div class="form-group">
                <a href="register.php" class="btn btn-outline-primary btn-block">สมัครสมาชิก</a>
            </div>
        </div>
    </div>
</body>
